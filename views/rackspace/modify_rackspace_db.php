...
if(isset($rackid, $rack_name, $rack_size, $rack_city, $rack_country, $rack_power, $rack_voltage)) {
	...
	$conn->query($sql);
	//echo $conn->error;
	$sql = "UPDATE `rackspace` SET `rack_power`='$rack_power' WHERE `rackid`='$rackid'";
	$conn->query($sql);
	//echo $conn->error;
	$sql = "UPDATE `rackspace` SET `rack_voltage`='$rack_voltage' WHERE `rackid`='$rackid'";
	$conn->query($sql);
	//echo $conn->error;
