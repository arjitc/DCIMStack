...
function my_success_handler($hash) {
    ...
    if (substr_count($hash['query'], 'SELECT')) {
...
class HookTest extends SimpleTest {
    public static function static_error_callback($hash) {
    ...
    public function nonstatic_error_callback($hash) {
    ...
    public function test_1_error_handler() {
    ...
    public function test_2_exception_catch() {
        $dbname = DB::$dbName;
        try {
            DB::query("SELET * FROM accounts");
    ...
    public function test_3_success_handler() {
        global $debug_callback_worked;
    ...
    public function test_4_error_handler() {
    ...
    public function test_5_post_run_success() {
    ...
    public function test_6_post_run_failed() {
        $callback_worked = false;
    ...
    public function test_7_pre_run() {
        $callback_worked = false;
    ...
    public function test_8_pre_parse() {
        $callback_worked = false;
    ...
    public function test_9_enough_args() {
        $error_worked = false;
    ...
    public function test_10_named_keys_present() {
        $error_worked = false;
    ...
    public function test_11_expect_array() {
        $error_worked = false;
    ...
    public function test_12_named_keys_without_array() {
        $error_worked = false;
    ...
    public function test_13_mix_named_numbered_args() {
        $error_worked = false;
    ...
    public function test_14_arrays_not_empty() {
        $error_worked = false;
    ...
    public function test_15_named_array_not_empty() {
        $error_worked = false;
