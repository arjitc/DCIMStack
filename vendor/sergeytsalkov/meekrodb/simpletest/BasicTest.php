...
class BasicTest extends SimpleTest {
    ...
    public function test_1_create_table() {
    ...
    public function test_1_5_empty_table() {
    ...
    public function test_2_insert_row() {
    ...
    public function test_3_more_inserts() {
      ...
      'favorite_word' => null,
        ...
        $charlie_password = DB::queryFirstField(
            "SELECT password FROM accounts WHERE username IN %ls AND username = %s",
            array('Charlie', 'Charlie\'s Friend'),
            'Charlie\'s Friend'
        );
        $this->assert($charlie_password === 'goodbye');

        $charlie_password = DB::queryOneField(
            'password',
            "SELECT * FROM accounts WHERE username IN %ls AND username = %s",
            array('Charlie', 'Charlie\'s Friend'),
            'Charlie\'s Friend'
        );
        $this->assert($charlie_password === 'goodbye');
    ...
    public function test_4_1_query() {
        DB::insert('accounts', array(
      'username' => 'newguy',
      ...
      'favorite_word' => null,
        ...
        $row = DB::query(
            "SELECT * FROM accounts WHERE password=%s_mypass AND (password=%s_mypass) AND username=%s_myuser",
    ...
    public function test_4_2_delete() {
        DB::insert('accounts', array(
      'username' => 'gonesoon',
      'password' => 'something',
      'age'      => 61,
    ...
    public function test_4_3_insertmany() {
        $ins[] = array(
      'username' => '1ofmany',
      'password' => 'something',
      'age'      => 23,
    ...
    public function test_5_insert_blobs() {
    ...
    public function test_6_insert_ignore() {
    ...
    public function test_7_insert_update() {
    ...
    public function test_9_fullcolumns() {
    ...
    public function test_901_updatewithspecialchar() {
    ...
    public function test_902_faketable() {
