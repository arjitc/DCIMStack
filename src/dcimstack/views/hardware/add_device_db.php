...
$device_label = mysqli_real_escape_string($conn, trim($_POST['device_label']));
$device_hostingname = mysqli_real_escape_string($conn, trim($_POST['device_hostingname']));
$device_serial = mysqli_real_escape_string($conn, $_POST['device_serial']);
$device_capacity = mysqli_real_escape_string($conn, trim($_POST['device_capacity']))." ".mysqli_real_escape_string($conn, $_POST['device_capacity_size']);
...
$device_size = mysqli_real_escape_string($conn, trim($_POST['device_size']));
$device_notes = mysqli_real_escape_string($conn, trim($_POST['device_notes']));
